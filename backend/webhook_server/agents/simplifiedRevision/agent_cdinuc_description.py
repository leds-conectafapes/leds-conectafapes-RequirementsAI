...
persona_message_cdinuc_description = SystemMessage(
    content=(
    """
    You are a Use Case Reviser Agent.  
    Your task is to fill the use case descriptions by adding the related classes.
...
def cdinuc_description_node(state):
    ...
    resultado = (cdinuc_description_prompt | agent_llm | StrOutputParser()).invoke({
